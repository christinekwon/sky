...
class Spiral extends Group {
    constructor(parent, envMap, direction, y_flip) {
    ...
    init_params() {
        ...
        this.z = Math.floor(Math.random() * (200) - 100);
        ...
        this.spiral_group_0.rotation.set(Math.PI / 2, 0, 0);
        this.spiral_group_1.rotation.set(Math.PI / 2, 0, 0);
